...
public class Calc_U_Later extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Button buttonCelsiusToFahrenheit = createConversionButton("°C en °F", e -> {
            String result = celsiusToFahrenheit(inputField.getText());
            inputField.setText(result);
        });
        Button buttonFahrenheitToCelsius = createConversionButton("°F en °C", e -> {
            String result = fahrenheitToCelsius(inputField.getText());
            inputField.setText(result);
        });
        Button buttonMeterToFeet = createConversionButton("Mètre en Pied", e -> {
            String result = meterToFeet(inputField.getText());
            inputField.setText(result);
        });
        Button buttonFeetToMeter = createConversionButton("Pied en Mètre", e -> {
            String result = feetToMeter(inputField.getText());
            inputField.setText(result);
        });
        Button buttonKilogramToPound = createConversionButton("Kilo en Pound", e -> {
            String result = kilogramToPound(inputField.getText());
            inputField.setText(result);
        });
        Button buttonPoundToKilogram = createConversionButton("Pound en Kilo", e -> {
            String result = poundToKilogram(inputField.getText());
            inputField.setText(result);
        });
        Button buttonLiterToGallon = createConversionButton("Litre en Gallon", e -> {
            String result = literToGallon(inputField.getText());
            inputField.setText(result);
        });
        Button buttonGallonToLiter = createConversionButton("Gallon en Litre", e -> {
            String result = gallonToLiter(inputField.getText());
            inputField.setText(result);
        });
        ...
        GridPane conversionPane = new GridPane();   // panel des boutons de conversion
        conversionPane.setPadding(new Insets(15, 0, 0, 2));
        ...
        rootPane.add(conversionPane, 0, 3, 2, 1);
        ...
        conversionPane.add(buttonCelsiusToFahrenheit, 0, 0);
        conversionPane.add(buttonFahrenheitToCelsius, 1, 0);
        conversionPane.add(buttonMeterToFeet, 2, 0);
        conversionPane.add(buttonFeetToMeter, 3, 0);
        conversionPane.add(buttonKilogramToPound, 0, 1);
        conversionPane.add(buttonPoundToKilogram, 1, 1);
        conversionPane.add(buttonLiterToGallon, 2, 1);
        conversionPane.add(buttonGallonToLiter, 3, 1);
    ...
    private Button createConversionButton(String type, javafx.event.EventHandler<javafx.event.ActionEvent> e) {
        Button button = new Button(type);
        button.setPrefWidth(112);
        button.setOnAction(e);
        return button;
    }
